...
//    }
    ...
    public void PostBottomSheet_Calendar(){
        BUTTON_Complete_LABEL = 2;

        RadioGroup radioGroup = bottomSheetDialog.findViewById(R.id.post_bottom_radio);
                radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(RadioGroup radioGroup, int i) {
                        EditText editText = bottomSheetDialog.findViewById(R.id.post_bottom_sheet_Text);
                        switch (i){
                            case R.id.radio_btn_collect :
                                editText.setText("");
                                editText.setHint("기한을 입력해주세요");
                                bottomSheetDialog.findViewById(R.id.post_bottom_layout_calendar).setVisibility(View.GONE);
                                bottomSheetDialog.findViewById(R.id.post_bottom_layout_text).setVisibility(View.VISIBLE);
                                PostBottomSheet_Calendar_Text();
                                break;
                            case R.id.radio_btn_deadline:
                                BUTTON_Complete_LABEL = 2;
                                bottomSheetDialog.findViewById(R.id.post_bottom_layout_calendar).setVisibility(View.VISIBLE);
                                bottomSheetDialog.findViewById(R.id.post_bottom_layout_text).setVisibility(View.GONE);
                                PostBottomSheet_Calendar_Day();
                                break;
