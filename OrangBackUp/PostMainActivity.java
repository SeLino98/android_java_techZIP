...
public class PostMainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putBoolean("isFabOpen", isFabOpen);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            // Do something based on the value of isFabOpen, like opening the FAB menu.
        }
...
//        Log.e("QUREYEQUREWQ",""+query);
        ...
        // = new PostViewPagerAdapter(this.getSupportFragmentManager(), this.getLifecycle());
        mAdapter = new PostViewPagerAdapter(this.getSupportFragmentManager(), this.getLifecycle());
